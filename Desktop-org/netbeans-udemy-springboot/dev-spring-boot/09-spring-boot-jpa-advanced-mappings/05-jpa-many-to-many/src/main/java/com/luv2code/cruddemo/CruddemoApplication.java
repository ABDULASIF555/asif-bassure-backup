...
//            deleteOnlyCourse(appDAO);

//            deleteOnlyStudent(appDAO);
        };
    }
...
//        
    ...
    private void createCourseWithStudents(AppDAO appDAO) {
        ...
        Student tempStudent1 = new Student("abdul asif", "abdul lathif", "abdulasif@gmail.com");
        Student tempStudent2 = new Student("abdul lathif", "ibrahim", "abdullathif@gmail.com");
    ...
    private void findCourseAndStudents(AppDAO appDAO) {
        int theId = 10;
        Course findedCourse = appDAO.findCourseAndStudentsByCourseId(theId);
        
        System.out.println("Finded Course : "+findedCourse);
        System.out.println("Associated Students : "+findedCourse.getStudents());
    }

    private void findStudentAndCourses(AppDAO appDAO) {
        int theId = 2;
        Student findedStudent = appDAO.findStudentAndCoursesWithStudentId(theId);
        System.out.println("Finded Student : "+findedStudent);
        System.out.println("Associated Courses : "+findedStudent.getCourses());
    }

    private void addMoreCoursesForStudents(AppDAO appDAO) {
        int theId = 4;
        Student student = appDAO.findStudentAndCoursesWithStudentId(theId);
...
//        student.addCourse(tempCourse1);
    ...
    private void deleteOnlyCourse(AppDAO appDAO) {
        int theId = 12;
        appDAO.deleteCourse(12);
    }
    
    

    private void deleteOnlyStudent(AppDAO appDAO) {
        int theId = 4;
